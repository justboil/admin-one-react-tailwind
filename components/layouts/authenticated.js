...
export default function LayoutAuthenticated({ children }) {
  ...
  return (
    <>
      ...
      <div className={`${darkMode ? 'dark' : ''} ${isAsideMobileExpanded ? 'overflow-hidden lg:overflow-visible' : ''}`}>
        <div className={`${layoutAsidePadding} ${isAsideMobileExpanded ? 'ml-60 lg:ml-0' : ''} pt-14 min-h-screen w-screen transition-position lg:w-auto bg-gray-50 dark:bg-slate-800 dark:text-slate-100`}>
